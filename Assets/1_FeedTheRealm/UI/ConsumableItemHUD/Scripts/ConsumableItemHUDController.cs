...
public class ConsumableItemHUDController : MonoBehaviour
{
    [Header("Menus")]
    [SerializeField]
    private GameObject listItemsMenu;

    [SerializeField]
    private GameObject addItemMenu;

    [SerializeField]
    private GameObject CreatorHUD;
    ...
    private void OnEnable()
    {
        ...
        {
            logger.Log(
                "ConsumableItemHUDController: UIDocument has no visual tree. Assign a UXML to the Source Asset.",
                this,
        ...
        if (addItemButton != null)
            addItemButton.clicked += OpenAddItemMenu;
        if (listItemsButton != null)
    ...
    private void RefreshItems()
    {
        ...
        var items =
            consumableItemsDatabase != null
                ? consumableItemsDatabase.GetAllConsumableItems() ?? new List<ConsumableItem>()
                : new List<ConsumableItem>();
    ...
    private void OnItemSelected(int index)
    {
        ...
        logger.Log(
            $"ConsumableItemHUDController: Selected item '{item.name}' (Effect {item.effectType}, Value {item.value})",
            this
        );
    ...
    private void OpenAddItemMenu()
    {
        ...
        {
            logger.Log(
                "ConsumableItemHUDController: Add Item menu reference is not set.",
                this,
    ...
    private void OpenListItemsMenu()
    {
        ...
        {
            logger.Log(
                "ConsumableItemHUDController: List Items menu reference is not set.",
                this,
                Logging.LogType.Warning
            );
        }
    ...
    private void CloseConsumableHUD()
    {
        ...
        {
            logger.Log(
                "ConsumableItemHUDController: CreatorHUD reference is not set.",
                this,
                Logging.LogType.Warning
            );
        }
