...
namespace FeedTheRealm.UI.EditorBar.ElementOption.LootMenu
{
    ...
    public class LootTableCreatorMenuController
    {
        ...
        // protected override CreatableObjectCategories Category => CreatableObjectCategories.LootTable;
        ...
        // public static List<Item> GetItems(CreatablesManager library)
        // {
        //     return library.GetAllCreatorObjects().OfType<Item>().ToList();
        // }

        // public static string GetItemDisplayNameById(CreatablesManager library, string itemId)
        // {
        ...
        //         item.DisplayName == itemListDropdown.value
        //     );
        //     if (selectedItem == null)
        //     {
        ...
        //     logger?.Log(
        //         $"Updated loot table: {currentObject.DisplayName}",
        //         this,
        //         Logging.LogType.Info
        //     );
        // }
