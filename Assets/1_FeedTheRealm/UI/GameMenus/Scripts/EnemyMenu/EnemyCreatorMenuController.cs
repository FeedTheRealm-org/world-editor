...
public class EnemyCreatorMenuController : MenuController
{
    ...
    //     valueInput.value = currentEnemy.value;
    //     durationInput.value = currentEnemy.duration;
    //     cooldownInput.value = currentEnemy.cooldown;
    //     maxStackInput.value = currentEnemy.maxStack;
    //     effectTypeInput.value = currentEnemy.effectType.ToString();
    ...
    //             spriteId: ""
    //         );
    //         currentEnemy = new ConsumableItem(itemData);
    //         creatorObjectLibrary.AddCreatable(CreatorObjectCategories.ConsumableItem, currentEnemy);
    //         logger.Log(
    //             $"Created new consumable item: {currentEnemy.DisplayName}",
    //             this,
    ...
    //         currentEnemy.value = valueInput.value;
    //         currentEnemy.duration = durationInput.value;
    //         currentEnemy.cooldown = cooldownInput.value;
    //         currentEnemy.maxStack = maxStackInput.value;
    //         currentEnemy.effectType = (EffectType)
    //             Enum.Parse(typeof(EffectType), effectTypeInput.value);
    //         logger.Log(
    //             $"Updated consumable item: {currentEnemy.DisplayName}",
    //             this,
    //             Logging.LogType.Info
    //         );
    //     }
